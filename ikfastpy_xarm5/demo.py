import numpy as np
import ikfastpy_xarm5

# Initialize kinematics for xArm5 robot arm
xarm5_kin = ikfastpy_xarm5.PyKinematics()
n_joints = xarm5_kin.getDOF()

joint_angles = [-3.1,-1.6,1.6,-1.6,-1.6] # in radians

# Test forward kinematics: get end effector pose from joint angles
print("\nTesting forward kinematics:\n")
print("Joint angles:")
print(joint_angles)
ee_pose = xarm5_kin.forward(joint_angles)
...
joint_configs = xarm5_kin.inverse(ee_pose.reshape(-1).tolist())
