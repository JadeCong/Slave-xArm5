...
def publisherCallback( msg ):
    try:
        ...
        (trans2,rot2) = listener.lookupTransform("/world", "/link_eef", rospy.Time(0))
        (trans3,rot3) = listener.lookupTransform("/link_eef", "/world",rospy.Time(0))
        ...
        fake_wrench.header.frame_id = "/link_eef"
...
if __name__ == "__main__":
    ...
    position = Point(0.207, 0.0, 0.112)
