...
if __name__ == "__main__":
    ...
    pub_fake_wrench = rospy.Publisher('/fake_wrench', WrenchStamped, queue_size=10)
    ...
    rospy.Timer(rospy.Duration(0.001), lambda msg: publisherCallback(msg, listener=tf_listener, pub=pub_fake_wrench, ref_frame="link_eef"))
    ...
    wrench_marker.description = "Sim Wrench\nForce = vector from xarm5 link_eef to fake_ft_marker\nTorque = angle from initial pose to fake_force_pose"
    wrench_marker.header.frame_id = "link_eef"
